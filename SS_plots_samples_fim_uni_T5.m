...
xid_comp_plot_T5(MCsim,1:plot_to_iter)=xid_min:(xid_max-xid_min)/(plot_to_iter-1):xid_max;

ysamples_uni_all_runs_FIM_T5(MCsim,1:plot_to_iter)=yid_comp_plot(plot_to_iter,1:plot_to_iter);

 
sample_pnts_uni=plot(xid_comp_plot_T5(MCsim,1:plot_to_iter),ysamples_uni_all_runs_FIM_T5(MCsim,1:plot_to_iter), ...
            'LineStyle','none',...
            'LineWidth',1,...
            'Marker','^',...
            'MarkerSize',8,...
...
filename = sprintf(['io_T5_%d'],MCsim);
