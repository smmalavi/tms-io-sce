...
%  when stopping rule is satisfied
%==========================================================================
%
% Matlab Code: 
...
yprim_uni_all_runs_FIM_T5_with_Peak(MCsim,1:plot_to_iter)=log(10)*(theta2_U(MCsim,plot_to_iter)-theta1_U(MCsim,plot_to_iter))*theta4_U(MCsim,plot_to_iter)...
     .*10.^((theta3_U(MCsim,plot_to_iter)-xid_comp_plot_T5_with_Peak(MCsim,1:plot_to_iter)).*theta4_U(MCsim,plot_to_iter))...
     ./(1+10.^((theta3_U(MCsim,plot_to_iter)-xid_comp_plot_T5_with_Peak(MCsim,1:plot_to_iter))*theta4_U(MCsim,plot_to_iter))).^2;

sample_pnts_uni=plot(xid_comp_plot_T5_with_Peak(MCsim,1:plot_to_iter),yprim_uni_all_runs_FIM_T5_with_Peak(MCsim,1:plot_to_iter), ...
            'LineStyle','none',...
            'LineWidth',1,...
            'Marker','^',...
            'MarkerSize',8,...
...
filename = sprintf(['dydx_T5_with_Peak_%d'],MCsim);
